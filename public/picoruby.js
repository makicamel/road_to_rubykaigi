...
var ASM_CONSTS = {
  520007: ($0) => { globalThis.picorubyRefs[$0] = null; },  
 520047: ($0) => { globalThis.picorubyRefs[$0] = true; },  
 520087: ($0) => { globalThis.picorubyRefs[$0] = false; },  
 520128: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 520166: ($0, $1) => { globalThis.picorubyRefs[$0] = $1; },  
 520204: ($0, $1, $2) => { const str = UTF8ToString($1, $2); globalThis.picorubyRefs[$0] = str; },  
 520277: ($0, $1) => { const arr = globalThis.picorubyRefs[$0]; const elem = globalThis.picorubyRefs[$1]; arr.push(elem); delete globalThis.picorubyRefs[$1]; },  
 520416: ($0, $1, $2) => { const obj = globalThis.picorubyRefs[$0]; const key = UTF8ToString($1); const val = globalThis.picorubyRefs[$2]; obj[key] = val; delete globalThis.picorubyRefs[$2]; }
};
